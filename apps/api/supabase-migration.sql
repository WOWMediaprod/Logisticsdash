...
-- CreateIndex
CREATE INDEX "job_requests_routeId_idx" ON "public"."job_requests"("routeId");
...
-- AddForeignKey
ALTER TABLE "public"."job_requests" ADD CONSTRAINT "job_requests_routeId_fkey" FOREIGN KEY ("routeId") REFERENCES "public"."routes"("id") ON DELETE SET NULL ON UPDATE CASCADE;
